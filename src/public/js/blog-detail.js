// Blog detail page with real-time comments using Socket.IO and Axios
...
async function loadBlog() {
  ...
  try {
    const response = await axios.get(
      `${API_BASE_URL}/blogs/${currentArticleId}`
    );
    ...
    container.innerHTML = `
      <article class="article-full">
        ...
        <div class="article-meta">
          ...
          <span class="readtime">${blog.Readtime} min read</span>
        </div>
        <div class="tags">
    ...
    container.innerHTML =
      '<p class="error">Failed to load blog. Please try again later.</p>';
  }
}
